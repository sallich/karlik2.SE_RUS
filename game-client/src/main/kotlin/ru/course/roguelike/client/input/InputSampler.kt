    ...
    fun sample(deltaSec: Float, inventoryOpen: Boolean): Sample {
        ...
        return Sample(
            input = InputSyncRequest(
                ...
                lookUp = if (inventoryOpen) false else pressed(Input.Keys.UP, Input.Keys.Q),
                ...
                reload = !inventoryOpen && Gdx.input.isKeyJustPressed(Input.Keys.F),
                inventoryCycle = inventoryOpen && Gdx.input.isKeyJustPressed(Input.Keys.Q),
                inventoryDrop = inventoryOpen && Gdx.input.isKeyJustPressed(Input.Keys.F),
