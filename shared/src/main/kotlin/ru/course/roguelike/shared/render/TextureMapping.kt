...
object AssetPaths {
    ...
    const val BOSS = "models/boss.png"
    const val PLAYER = "models/person.png"
    const val PISTOL = "models/pistol.png"
    const val SHOTGUN = "models/shotgun.png"
    const val PISTOL_AMMO = "models/pistol_ammo.png"
    const val SHOTGUN_AMMO = "models/shotgun_ammo.png"
    const val FIRST_AID = "models/first_aid.png"
    const val PISTOL_FIRST = "models/pistol_first.png"
    const val SHOTGUN_FIRST = "models/shotgun_first.png"
    const val FIRE_WALL = "textures/firewalb.png"
